...
Build runnable speech features and generate playable audio with cost estimates and resumable jobs.
...
Live generation uses your own CastReader Voice API key and trial/wallet. App Pro is separate. This repository is a public Git marketplace; OpenAI Plugins Directory review and publication are separate.
