...
Read formatted answers with synchronized highlighting, build runnable speech features, and generate playable audio. The membership reader is an English preview; directory version 0.1.2 remains the published developer release.
